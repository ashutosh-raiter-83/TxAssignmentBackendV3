...
public class Robot
{
    ...
    /// <summary>
    /// If null, nothing is held.
    /// </summary>
    public string? HeldItemLabel { get; set; }
    ...
    public bool IsHoldingItem => HeldItemLabel != null;

    public RobotShared.Model.Robot ToShared()
    {
        return new RobotShared.Model.Robot()
        {
            ZPosition = ZPosition,
            FacingDirection = FacingDirection,
            IsHoldingItem = IsHoldingItem,
            FlagReason = FlagReason,
            FlaggedUnsortedBins = FlaggedUnsortedBins,
            FlaggedLabeledBins = FlaggedLabeledBins,
            ServerCausedFlagCount = ServerCausedFlagCount,
            CorrectSortCount = CorrectSortCount,
        };
    }
}
